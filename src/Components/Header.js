...
export default function Header()
{
    ...
    return(
        <div className="grid Header w-full bg-cover text-white" style={{backgroundImage:`url(${Hbg})`}}>
            ...
            {nav && 
            <div className="flex flex-col w-min ml-auto justify-start bg-opacity-60 bg-gray-600" style={{gridArea:"side"}}>
                <a className="p-3">Catalog</a>
                <a className="p-3">Sale</a>
                <a className="p-3">New Arrival</a>
                <a className="p-3">About</a>
            </div>}
            <div className="promo flex overflow-x-hidden justify-end items-end" style={{gridArea:"promo1"}}>
            ...
            <div className="promo flex overflow-x-hidden justify-end items-start text-4xl" style={{gridArea:"promo2"}}>
                <img className="h-3/5"  src={random} />
                <div className="flex h-3/5 w-2/5 flex-col text-gray-500 justify-evenly items-center bg-white ">
                    <span class="material-symbols-outlined text-4xl">
                    percent_discount
